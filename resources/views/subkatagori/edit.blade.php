      ...
      <div class="row">
        <div class="col-12">
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama_subkatagori" id="nama_subkatagori" aria-describedby="emailHelp" placeholder="Nama Katagori" value="{{$data->nama_subkatagori}}">
                </div>
          <div class="form-group">
